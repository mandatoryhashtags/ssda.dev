...
$cakeDescription = 'Springfield Self Defense Academy';
?>
<!DOCTYPE html>
<html>
<head>
...
<nav class="top-bar expanded" data-topbar role="navigation">
    ...
    <section class="top-bar-section">
        <ul class="right">
            <li class="selected"><?= $this->Html->link(__('Students'), ['controller' => 'Students', 'action' => 'index']) ?></li>
            <li><?= $this->Html->link(__('Courses'), ['controller' => 'Courses', 'action' => 'index']) ?></li>
            <li><?= $this->Html->link(__('Sessions'), ['controller' => 'Sessions', 'action' => 'index']) ?></li>
